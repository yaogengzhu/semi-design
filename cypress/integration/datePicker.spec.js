...
describe('DatePicker', () => {
    ...
    it('inlineInput + date', () => {
        cy.visit('http://localhost:6006/iframe.html?id=datepicker--inline-input-e-2-e&args=&viewMode=story');   
    ...
    it('inlineInput + dateTimeRange + check click range start ', () => {
        cy.visit('http://localhost:6006/iframe.html?id=datepicker--inline-input-e-2-e&args=&viewMode=story');   
        cy.get('[data-cy=dateTimeRange]').scrollIntoView();
        cy.get('[data-cy=dateTimeRange] .semi-input').eq(0).click();
        cy.get('.semi-popover .semi-datepicker-month-grid-right').contains('10').click();
    ...
    it('inlineInput + dateTimeRange + check click range end', () => {
        cy.visit('http://localhost:6006/iframe.html?id=datepicker--inline-input-e-2-e&args=&viewMode=story');   
        cy.get('[data-cy=dateTimeRange]').scrollIntoView();
    ...
    it('inlineInput + trigger input disabled', () => {
        cy.visit('http://localhost:6006/iframe.html?id=datepicker--inline-input-e-2-e&args=&viewMode=story');
